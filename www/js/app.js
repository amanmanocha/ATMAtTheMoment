...
angular.module('starter', ['ionic', 'ngCordova'])
 ...
 .controller(
  'MapCtrl', [
   ...
   function($scope, $http, $cordovaGeolocation) {
    function initialize() {
     ...
     $cordovaGeolocation.getCurrentPosition(options).then(locationLoaded, canNotLoadLocation);
    ...
    function locationLoaded(position) {
     ...
     // Create the autocomplete helper, and associate
     // it with
  ...
  function canNotLoadLocation(error){
